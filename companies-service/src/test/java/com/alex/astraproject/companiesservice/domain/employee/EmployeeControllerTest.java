...
public class EmployeeControllerTest {
  ...
  public void createEmployeeCommand() {
    ...
    CreateEmployeeCommand command = new CreateEmployeeCommand(
      "Alan", "Morgan", "morgan@gmail.com", "123456", mockCompanyId, mockPositionId
    );
  ...
  @Test
	...
	@Test
	public void changeEmployeePositionCommand() {
  	String mockPositionId = UUID.randomUUID().toString();
		...
		mockPosition.setId(mockPositionId);
		...
		client.patch().uri("/employees/{id}/change-position", employeeId)
